...
const Products = () => {
  ...
  useEffect(() => {
    ...
    let restoreProductIdFromState = location.state?.restoreProductId;
    ...
    if (!restoreTarget && navigationType === "POP") {
      ...
      if (pendingRestore?.productId) {
        ...
        restoreProductIdFromState = pendingRestore.productId;
      }
    }
    ...
    const timerId = window.setTimeout(() => {
      ...
      if (!targetElement && restoreTarget === PRODUCTS_RESTORE_SCROLL_TARGET) {
        const paginationTopElement = document.querySelector(
          ".pagination.pagination-top",
        );
        const productsInfoElement = document.querySelector(".products-info");
        targetElement = paginationTopElement || productsInfoElement;
      }
      ...
      if (targetElement) {
        ...
        const top =
          ...
          window.scrollY -
          (navHeight + activeFilterHeight + extraGap);
